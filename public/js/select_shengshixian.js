...
document.addEventListener('DOMContentLoaded', function(){
    ...
    handleSelectChange();
    // 一开始就为city_select元素添加事件监听器
    const citySelect = document.getElementById('city_select');
    citySelect.removeEventListener('change', citySelectChangeHandler); // 移除旧的
    citySelect.addEventListener('change', citySelectChangeHandler); // 添加新的
});
