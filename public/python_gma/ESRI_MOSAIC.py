...
#裁剪
#输入文件夹
INPUT_DIR=r"F:\landcover100_com_DB\Land_Cover\high_resolution\ESRI_worldcover\2017-2021年全国土地利用分类数据（精度为10m）"

#输出路径
OUTPUT_PATH=r"F:\landcover100_com_DB\Land_Cover\high_resolution\ESRI_worldcover\mosaic\mosaic\\"
...
for Input_tif_year in tqdm(Input_tif_years):
    ...
    for Input_tif_year_folder in tqdm(Input_tif_year_folders):
        try:
            ...
            output_file_name=output_file_path+"\\"+"esri_landcover_"+NAME
